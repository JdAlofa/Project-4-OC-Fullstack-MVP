        ...
        return args -> {
            ...
            if (themeRepository.count() == 0) {
                ...
                Theme theme1 = Theme.builder().title("Java")
                        .description("Discussions about Java, Spring, and the JVM ecosystem.").build();
                Theme theme2 = Theme.builder().title("JavaScript")
                        .description("All things JavaScript: React, Angular, Vue, Node.js, and more.").build();
                Theme theme3 = Theme.builder().title("Databases")
                        .description("Topics related to SQL, NoSQL, performance, and data modeling.").build();
            ...
            if (articleRepository.count() == 0) {
                ...
                // Java Articles
                Theme javaTheme = themes.stream().filter(t -> t.getTitle().equals("Java")).findFirst().get();
                ...
                // JavaScript Articles
                Theme jsTheme = themes.stream().filter(t -> t.getTitle().equals("JavaScript")).findFirst().get();
                articles.add(Article.builder().title("React Server Components vs. Client Components").content(
                ...
                // Databases Articles
                Theme dbTheme = themes.stream().filter(t -> t.getTitle().equals("Databases")).findFirst().get();
                ...
                // DevOps Articles
                Theme devopsTheme = themes.stream().filter(t -> t.getTitle().equals("DevOps")).findFirst().get();
